...
main(int argc, char* argv[])
{
  ...
  topologyReader.SetFileName("scratch/test-robust.txt");
  topologyReader.Read();
 ...
 // The failure of the link connecting consumer and router will start from seconds 10.0 to 15.0
  ...
  // Simulator::Schedule(Seconds(70.0), ndn::LinkControlHelper::FailLinkByName, "R4", "R3");
  // Simulator::Schedule(Seconds(80.0), ndn::LinkControlHelper::UpLinkByName, "R4", "R3");
