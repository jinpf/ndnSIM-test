...
#ifndef NDN_APP_DELAY_TRACER_S_H
#define NDN_APP_DELAY_TRACER_S_H
 ...
 */
class AppDelayTracerS : public SimpleRefCount<AppDelayTracerS> {
public:
  /**
   ...
   */
  AppDelayTracerS(shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  AppDelayTracerS(shared_ptr<std::ostream> os, const std::string& node);
...
private:
  ...
  void
  PacketRecord(Ptr<App> app, std::string type, std::string pname, int32_t seqno, int32_t hopCount);
